...
<main class="overflow-y-auto p-4 md:p-8 pt-24 bg-[#f1f5f9] min-h-screen">
    <div class="max-w-[1600px] mx-auto w-full">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 px-2">
            <div>
                <h1 class="text-3xl md:text-4xl font-black text-slate-900 uppercase tracking-tighter italic">Profit & Loss</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10 px-2">
            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-lg border border-slate-50 relative overflow-hidden group">
                ...
                <h2 class="text-xl md:text-2xl font-black text-slate-900 mt-1 relative z-10 tracking-tighter italic leading-none">PKR {{ number_format($totalRevenue) }}</h2>
                <div class="mt-4 flex items-center justify-between relative z-10">
                    <span class="text-[8px] font-black text-slate-600 bg-slate-100 px-2 py-1 rounded-lg uppercase italic">Total Intake</span>
            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-lg border border-slate-50 relative overflow-hidden group">
                ...
                <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest relative z-10">Purchase Cost</p>
                <h2 class="text-xl md:text-2xl font-black text-slate-900 mt-1 relative z-10 tracking-tighter italic leading-none">PKR {{ number_format($totalCost) }}</h2>
                <div class="mt-4 flex items-center justify-between relative z-10">
                    <span class="text-[8px] font-black text-red-600 bg-red-50 px-2 py-1 rounded-lg uppercase italic">Buying Price</span>
            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-lg border border-slate-50 relative overflow-hidden group">
                ...
                <h2 class="text-xl md:text-2xl font-black text-slate-900 mt-1 relative z-10 tracking-tighter italic leading-none">PKR {{ number_format($grossProfit) }}</h2>
                <div class="mt-4 flex items-center justify-between relative z-10">
                    <span class="text-[8px] font-black text-amber-600 bg-amber-100 px-2 py-1 rounded-lg uppercase italic">Net Margin</span>
            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-lg border border-slate-50 relative overflow-hidden group">
                ...
                <h2 class="text-xl md:text-2xl font-black text-[#0f172a] mt-1 relative z-10 tracking-tighter italic leading-none">{{ number_format($profitMargin, 1) }}%</h2>
                <div class="mt-4 flex items-center justify-between relative z-10">
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="border-t border-slate-700 border-dashed pt-6 flex justify-between items-center">
                    <div class="flex flex-col">
                        ...
                        <span class="text-3xl font-black text-white italic uppercase tracking-tighter leading-none mt-1">Gross Profit</span>
                    </div>
