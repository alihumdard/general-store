    ...
    <main class="h-screen overflow-y-auto p-4 md:p-8 pt-24 bg-[#f1f5f9] flex flex-col" 
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-slate-50 transition group">
                                    <td class="py-5 px-6 align-top">
                                        <div class="font-black text-slate-900 tracking-tighter italic text-lg leading-none">#<?php echo e($order->po_number); ?></div>
                                    ...
                                    <td class="py-5 px-6 text-center align-top">
                                        <div class="flex items-center justify-center gap-2">
                                            <button onclick="editPO(<?php echo e($order->id); ?>)" class="w-9 h-9 rounded-xl bg-slate-50 text-slate-400 flex items-center justify-center hover:bg-[#f59e0b] hover:text-white transition shadow-sm">
                                                <i class="fa-solid fa-pen-to-square text-xs"></i>
                                            </button>
                                            <button onclick="deletePO(<?php echo e($order->id); ?>)" class="w-9 h-9 rounded-xl bg-red-50 text-red-300 flex items-center justify-center hover:bg-red-600 hover:text-white transition shadow-sm">
                ...
                <div class="p-4 md:p-8 overflow-y-auto custom-scrollbar flex-grow bg-[#f8fafc]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <input id="po_date" type="date" value="<?php echo e(date('Y-m-d')); ?>" class="w-full px-4 py-3 bg-white border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-[#f59e0b] font-bold text-sm shadow-sm">
                        </div>
                        <div>
        ...
        <script>
            ...
            window.submitFinalPO = async () => {
                ...
                const url = isEditMode ? `/purchase-orders/${editPoId}` : "<?php echo e(route('po.store')); ?>";
                try {
