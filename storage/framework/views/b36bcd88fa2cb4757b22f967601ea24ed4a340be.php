...
<head>
    ...
    <title>RetailPro POS - Account Recovery</title>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        // Professional Retail Palette: Slate & Amber
    ...
    <div class="w-full max-w-md p-8 sm:p-10 bg-store-card rounded-3xl shadow-3xl transition duration-500">
        ...
        <div class="flex flex-col items-center mb-8">
            <div class="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-4 border border-slate-100 shadow-sm">
                <i class="fas fa-key text-3xl text-store-accent"></i>
            </div>
            <h2 class="text-3xl font-black text-store-primary text-center tracking-tight">Recover Access</h2>
            <p class="text-center text-slate-500 mt-2 font-medium">
                Enter your merchant email to receive a secure password reset link.
            </p>
        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(session('status')): ?>
                <div class="mb-6 p-4 bg-green-50 text-xs font-bold text-center text-green-700 rounded-2xl border border-green-100 flex items-center justify-center uppercase tracking-tighter" role="alert">
                    <i class="fas fa-check-circle mr-2 text-base"></i> <?php echo e(session('status')); ?>
            ...
            <button 
                ...
                <i class="fas fa-paper-plane text-store-accent group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"></i>
            </button>
        </form>
        ...
        <div class="mt-10 pt-8 border-t border-slate-100 text-center">
            <p class="text-sm text-slate-400 font-medium">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-store-primary hover:text-store-accent font-black transition duration-200 ml-1">
                    Return to Login
                </a>
            </p>
        </div>
...
</html><?php /**PATH E:\code_2\general-store\resources\views/pages/auth/password/email.blade.php ENDPATH**/ ?>